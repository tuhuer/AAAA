...
UUID=${UUID:-'6456a4c6-e286-44a8-a3a4-ad675fe92e2e'}
VMESS_WSPATH=${VMESS_WSPATH:-'/6456a4c6-e286-44a8-a3a4-ad675fe92e2e-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/6456a4c6-e286-44a8-a3a4-ad675fe92e2e-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/6456a4c6-e286-44a8-a3a4-ad675fe92e2e-trojan'}
SS_WSPATH=${SS_WSPATH:-'/6456a4c6-e286-44a8-a3a4-ad675fe92e2e-shadowsocks'}
